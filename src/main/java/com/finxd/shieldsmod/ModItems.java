...
public class ModItems {
    ...
    public static final RegistryObject<Item> COPPER_SHIELD = ITEMS.register("copper_shield", () -> new CopperShieldItem((new Item.Properties()).durability(115)));
    public static final RegistryObject<Item> IRON_SHIELD = ITEMS.register("iron_shield", () -> new IronShieldItem((new Item.Properties()).durability(165)));
    public static final RegistryObject<Item> DIAMOND_SHIELD = ITEMS.register("diamond_shield", () -> new DiamondShieldItem((new Item.Properties()).durability(363)));
    public static final RegistryObject<Item> NETHERITE_SHIELD = ITEMS.register("netherite_shield", () -> new NetheriteShieldItem((new Item.Properties()).durability(407).fireResistant()));
