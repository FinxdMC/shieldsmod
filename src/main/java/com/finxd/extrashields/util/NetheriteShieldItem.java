package com.finxd.extrashields.util;
...
public class NetheriteShieldItem extends ShieldItem implements Equipable {
    public static final int EFFECTIVE_BLOCK_DELAY = 5;
    public static final float MINIMUM_DURABILITY_DAMAGE = 3F;

    public NetheriteShieldItem(Properties p_43089_) {
        super(p_43089_);
    ...
    public boolean isValidRepairItem(ItemStack p_43091_, ItemStack p_43092_) {
        return p_43092_.is(Items.NETHERITE_INGOT) || super.isValidRepairItem(p_43091_, p_43092_);
    }
